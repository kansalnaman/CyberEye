...
# ---------- CONFIG ----------
YOUR_EMAIL = "kansalnaman88@gmail.com"       # apna gmail
APP_PASSWORD = "cighibfabqjojlsj"  # Gmail App Password (16 chars)
TO_EMAIL = "kansalnaman88@gmail.com"         # jahan alert chahiye
